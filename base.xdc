...
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { uart_tx }]; #IO_L19P_T3_34 Sch=ar[6]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { uart_rx }]; #IO_L9N_T1_DQS_34 Sch=ar[7]
...
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { hdmi_rx_scl_io }]; #IO_L11P_T1_SRCC_34 Sch=hdmi_rx_scl_io
#set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { hdmi_rx_sda_io }]; #IO_L11N_T1_SRCC_34 Sch=hdmi_rx_sda_io
